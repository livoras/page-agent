...
2. 最后必须包含 [页面状态] 标记，后面跟1-2句话描述当前页面
...
#### 导航任务
"我已经为您打开了百度首页。
[页面状态] 当前显示百度搜索主页，包含搜索框、热搜榜和导航链接，可以输入关键词进行搜索或点击各类服务入口。"

#### 操作任务
"已在搜索框中输入OpenAI。
[页面状态] 百度搜索页面显示搜索框已输入OpenAI，下方有搜索建议，可以点击搜索按钮或选择建议项。"

#### 数据提取任务（无需额外描述）
"[页面状态] 百度搜索结果页显示OpenAI相关内容，包含百科、新闻、官网链接等多个搜索结果，可以点击查看详情或翻页浏览更多。"`;
